...
@onready var textbox_with_speaker_portrait: Control = $"."
...
func _process(delta: float) -> void:
	if Global.dialogue_is_top:
		textbox_with_speaker_portrait.position.y = -750
	else:
		textbox_with_speaker_portrait.position.y = 0
